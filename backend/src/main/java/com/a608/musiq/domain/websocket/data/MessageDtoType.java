...
public enum MessageDtoType {
    MUSICPROBLEM, SINGERHINT, INITIALHINT, TIME, GAMERESULT, CHAT, BEFORESKIP, AFTERSKIP, BEFOREANSWERCORRECT, MUSICPLAY, MUSICEND, GOWAITING, GAMESTART, ENTERUSER, EXITUSER, MODIFYINFO
    /** MUSICPROBLEM : 문제 출제
     * SINGERHINT : 가수 힌트
